...
class ProjectLimit extends Model
{
    ...
    protected $fillable = [
        'id', 'project_id', 'day_active', 'time_start', 'time_finish', 'max_works', 'max_works_day', 'time_off_min',
        'time_off_max', 'in_hour', 'in_page', 'in_page_on_day', 'author_count', 'author_count_on_day', 'author_count_in_akk', 'author_count_in_group_project',
