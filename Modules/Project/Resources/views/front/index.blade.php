        ...
        <div class="all__project">
            ...
            {{--<div class="project__item yellow__project">
                    ...
                    <div class="describe__inner">
                        ...
                        <div class="name-social name-social-1">
                            <a href="index.html#" class="back-1">
                                <img src="img/_src/gmail.svg" alt="Гмаил" class="color-normal-1">
                            </a>
                            <a href="index.html#" class="back-2">
                                <img src="img/_src/instagram.svg" alt="Инстаграм" class="color-normal-2">
                            </a>
                            <a href="index.html#" class="back-3">
                                <img src="img/_src/twitter.svg" alt="Твиттер" class="color-normal-3">
                            </a>
                            <a href="index.html#" class="back-4">
                                <img src="img/_src/vk.svg" alt="Вк" class="color-normal-4">
                            </a>
                            <a href="index.html#" class="back-5">
                                <img src="img/_src/youtube.svg" alt="Ютуб" class="color-normal-5">
                            </a>
                            <a href="index.html#" class="back-6">
                                <img src="img/_src/telegram.svg" alt="Телеграм" class="color-normal-6">
                            </a>
                            <a href="index.html#" class="back-7">
                                <img src="img/_src/facebook.svg" alt="Фэйсбук" class="color-normal-7">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="tariph__project">
                    ...
                    <div class="tariph__icon">
                        <div class="icon__tariph"><img src="img/_src/chat.svg" width="17" alt="icon__tariph"><span>2</span></div>
                        <div class="icon__tariph"><img src="img/_src/sad.svg" width="16" alt="icon__tariph"><span>5</span></div>
                    </div>
                    <div class="tariph__flag">
                        <span><img src="img/_src/flag__tariph.png" alt="flag__tariph"></span>
                    </div>
                </div>
                ...
                <div class="actions__project">
                    ...
                    <div class="pause__btn">
                        <a href="#"><span><img src="img/_src/pause__img.svg" width="17" alt="pause__img"></span>Приостановить</a>
                    </div>

                    <div class="absolute__checkbox">
                        <input type="checkbox" id="choose__check2">
                        <label for="choose__check2">Выбрать</label>
                    </div>
                </div>
            </div>
            <div class="project__item blue__project">
                ...
                <div class="actions__project">
                    ...
                    <div class="enter__btn">
                        <a href="#"><span><img src="img/_src/play.svg" alt="zapusk__img"></span>Запустить</a>
                    </div>

                    <div class="absolute__checkbox">
                        <input type="checkbox" id="choose__check3">
                        <label for="choose__check3">Выбрать</label>
                    </div>
                </div>
            </div>
            <div class="project__item red__project">
                ...
                <div class="actions__project">
                    ...
                    <div class="absolute__checkbox">
                        <input type="checkbox" id="choose__check4">
                        <label for="choose__check4">Выбрать</label>
                    </div>
                </div>
            </div>--}}
