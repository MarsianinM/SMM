...
@section('content')
    ...
    <div class="table-wrap group__project__table">
        <table>
            ...
            <tbody>
            <tr>
                <td data-label="ID">102132</td>
                <td data-label="Название группы">
                    Home group
                </td>
                <td data-label="Проектов">250</td>
                <td style="text-align: right;">
                    <img class="icon__blank" src="img/_src/comment__icon.png" alt="comment__icon">
                    <img class="icon__blank" src="img/_src/pancel__icon.png" alt="korzina__icon">
                    <img class="icon__blank" src="img/_src/korzina__icon.png" alt="korzina__icon">
                </td>
            </tr>
