...
!function (t, e) {
    ...
    var r, s, a, l, c = "transitionend", u = function (t) {
            do {
            ...
            set: function (t, e, n) {
                "undefined" == typeof t.key && (t.key = {key: e, id: s}, s++), r[t.key.id] = n
            }, get: function (t, e) {
    ...
    function U(t, e, n) {
        var i = "string" == typeof e, o = i ? n : e, r = t.replace(I, ""), s = H[r];
    ...
    function q(t, e, n, i, o) {
        if ("string" == typeof e && t) {
            n || (n = i, i = null);
            var r = U(e, n, i), s = r[0], a = r[1], l = r[2], c = X(t), u = c[l] || (c[l] = {}),
                f = B(u, a, s ? n : null);
            if (f) f.oneOff = f.oneOff && o; else {
                var h = Y(a, e.replace(N, "")), d = s ? function (t, e, n) {
                    return function i(o) {
                        for (var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode) for (var a = r.length; a--;) if (r[a] === s) return o.delegateTarget = s, i.oneOff && F.off(t, o.type, n), n.apply(s, [o]);
                        return null
                    }
                }(t, n, i) : function (t, e) {
                    return function n(i) {
    ...
    var F = {
            on: function (t, e, n, i) {
                ...
                if ("string" == typeof e && t) {
                    var o = U(e, n, i), r = o[0], s = o[1], a = o[2], l = a !== e, c = X(t), u = "." === e.charAt(0);
                ...
                var i, o = e.replace(I, ""), r = e !== o, s = W.indexOf(o) > -1, a = !0, l = !0, c = !1, u = null;
        ...
        Z = {defaultPage: "main.html", errorPage: "404.html", subpagesDirectory: "views/"}, tt = function () {
            function t(t, e) {
            ...
            return n._getConfig = function (t) {
                ...
                var e = this, n = this._element, i = this._config, o = function t(n, i) {
                    void 0 === i && (i = 0);
                ...
                var s = new CustomEvent("xhr", {detail: {url: t, status: r.status}});
                n.dispatchEvent(s), r.onload = function (e) {
                    if (200 === r.status) {
                        s = new CustomEvent("xhr", {detail: {url: t, status: r.status}}), n.dispatchEvent(s);
    ...
    var it = "coreui.alert", ot = function () {
        function t(t) {
    ...
    var at = {
        ...
        }, lt = "coreui.button", ct = "active", ut = "disabled", ft = "focus", ht = '[data-toggle^="button"]', dt = ".btn",
        pt = function () {
            function t(t) {
            ...
            return n.toggle = function () {
                var t = !0, e = !0, n = this._element.closest('[data-toggle="buttons"]');
                if (n) {
    ...
    F.on(document, "click.coreui.button.data-api", ht, (function (t) {
        t.preventDefault();
        var e = t.target.closest(dt), n = O(e, lt);
    ...
    var bt = {
        ...
        }, yt = "carousel", wt = "coreui.carousel", Et = "." + wt,
        Lt = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, Tt = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, kt = "next", Ot = "prev", Ct = "slid" + Et, St = "active", At = ".active.carousel-item",
        xt = {TOUCH: "touch", PEN: "pen"}, Dt = function () {
            function t(t, e) {
            ...
            return n.next = function () {
                ...
                var t = this, e = function (e) {
                    t._pointerEvent && xt[e.pointerType.toUpperCase()] ? t.touchStartX = e.clientX : t._pointerEvent || (t.touchStartX = e.touches[0].clientX)
                }, n = function (e) {
                ...
                var n = t === kt, i = t === Ot, o = this._getItemIndex(e), r = this._items.length - 1;
                if ((i && 0 === o || n && o === r) && !this._config.wrap) return e;
                var s = (o + (t === Ot ? -1 : 1)) % this._items.length;
                return -1 === s ? this._items[this._items.length - 1] : this._items[s]
            }, n._triggerSlideEvent = function (t, e) {
                var n = this._getItemIndex(t), i = this._getItemIndex(at.findOne(At, this._element));
                return F.trigger(this._element, "slide.coreui.carousel", {relatedTarget: t, direction: e, from: i, to: n})
            }, n._setActiveIndicatorElement = function (t) {
                if (this._indicatorsElement) {
                    for (var e = at.find(".active", this._indicatorsElement), n = 0; n < e.length; n++) e[n].classList.remove(St);
                    var i = this._indicatorsElement.children[this._getItemIndex(t)];
                    i && i.classList.add(St)
                }
            }, n._slide = function (t, e) {
                var n, i, o, r = this, s = at.findOne(At, this._element), a = this._getItemIndex(s),
                    l = e || s && this._getItemByDirection(t, s), u = this._getItemIndex(l), f = Boolean(this._interval);
                    ...
                    if (this._isSliding = !0, f && this.pause(), this._setActiveIndicatorElement(l), this._element.classList.contains("slide")) {
                        ...
                        F.one(s, c, (function () {
                            l.classList.remove(n, i), l.classList.add(St), s.classList.remove(St, i, n), r._isSliding = !1, setTimeout((function () {
                                F.trigger(r._element, Ct, {relatedTarget: l, direction: o, from: a, to: u})
                            }), 0)
                        })), v(s, d)
                ...
                var i = O(e, wt), r = o(o({}, Lt), bt.getDataAttributes(e));
    ...
    F.on(document, "click.coreui.carousel.data-api", "[data-slide], [data-slide-to]", Dt.dataApiClickHandler), F.on(window, "load.coreui.carousel.data-api", (function () {
        for (var t = at.find('[data-ride="carousel"]'), e = 0, n = t.length; e < n; e++) Dt.carouselInterface(t[e], O(t[e], wt))
    }));
    var jt = L();
    if (jt) {
        var Nt = jt.fn[yt];
    ...
    var It = "class-toggler", Pt = "coreui.class-toggler", Rt = {
        ...
        target: "body",
        toggleClass: null
    }, Ht = "classremoved", Wt = "classtoggle", Yt = ".c-class-toggler", Xt = function () {
        function t(t, e) {
        ...
        return n.add = function () {
            ...
            var t = this, e = this._target(), n = this._config.toggleClass.replace(/\s/g, "").split(",");
            ...
            var o = new CustomEvent(t, {detail: {target: e, add: n, className: i}});
            e.dispatchEvent(o)
    ...
    var qt = "collapse", Qt = "coreui.collapse", Ft = {toggle: !0, parent: ""},
        Vt = {toggle: "boolean", parent: "(string|element)"}, zt = "show", Kt = "collapse", $t = "collapsing",
        Gt = "collapsed", Jt = "width", Zt = '[data-toggle="collapse"]', te = function () {
            function t(t, e) {
                ...
                for (var n = at.find(Zt), i = 0, o = n.length; i < o; i++) {
                    var r = n[i], s = h(r), a = at.find(s).filter((function (e) {
                        return e === t
                    }));
            ...
            return n.toggle = function () {
                ...
                var i = O(e, Qt), r = o(o(o({}, Ft), bt.getDataAttributes(e)), "object" == typeof n && n ? n : {});
    ...
    F.on(document, "click.coreui.collapse.data-api", Zt, (function (t) {
        ...
        var e = bt.getDataAttributes(this), n = h(this);
    ...
    var ie = "top", oe = "bottom", re = "right", se = "left", ae = "auto", le = [ie, oe, re, se], ce = "start",
        ue = "end", fe = "viewport", he = "popper", de = le.reduce((function (t, e) {
    ...
    function Se(t) {
        for (var e = ve(t), n = Ce(t); n && Te(n) && "static" === Le(n).position;) n = Ce(n);
    ...
    function Ie(t) {
        var e, n = t.popper, i = t.popperRect, o = t.placement, r = t.offsets, s = t.position, a = t.gpuAcceleration,
            ...
            }(r), u = c.x, f = c.y, h = r.hasOwnProperty("x"), d = r.hasOwnProperty("y"), p = se, g = ie, m = window;
        if (l) {
            var v = Se(n);
            v === ve(n) && (v = ke(n)), o === ie && (g = oe, f -= v.clientHeight - i.height, f *= a ? 1 : -1), o === se && (p = re, u -= v.clientWidth - i.width, u *= a ? 1 : -1)
        }
        var _, b = Object.assign({position: s}, l && Ne);
    ...
    function Ue(t) {
        var e = Le(t), n = e.overflow, i = e.overflowX, o = e.overflowY;
    ...
    function Qe(t, e) {
        void 0 === e && (e = []);
        var n = qe(t), i = "body" === me(n), o = ve(n), r = i ? [o].concat(o.visualViewport || [], Ue(n) ? n : []) : n,
            s = e.concat(r);
    ...
    function Ve(t, e) {
        return e === fe ? Fe(function (t) {
            var e = ve(t), n = ke(t), i = e.visualViewport, o = n.clientWidth, r = n.clientHeight, s = 0, a = 0;
            ...
            var e = ke(t), n = Xe(t), i = t.ownerDocument.body,
                o = Math.max(e.scrollWidth, e.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0),
                r = Math.max(e.scrollHeight, e.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0),
                s = -n.scrollLeft + Be(t), a = -n.scrollTop;
    ...
    function ze(t, e, n) {
        var i = "clippingParents" === e ? function (t) {
            var e = Qe(Oe(t)), n = ["absolute", "fixed"].indexOf(Le(t).position) >= 0 && be(t) ? Se(t) : t;
    ...
    function $e(t) {
        var e, n = t.reference, i = t.element, o = t.placement, r = o ? ye(o) : null, s = o ? Ke(o) : null,
    ...
    function Ge(t, e) {
        ...
        var n = e, i = n.placement, o = void 0 === i ? t.placement : i, r = n.boundary,
            s = void 0 === r ? "clippingParents" : r, a = n.rootBoundary, l = void 0 === a ? fe : a,
            c = n.elementContext, u = void 0 === c ? he : c, f = n.altBoundary, h = void 0 !== f && f, d = n.padding,
            p = void 0 === d ? 0 : d, g = De("number" != typeof p ? p : je(p, le)), m = u === he ? "reference" : he,
            v = t.elements.reference, _ = t.rects.popper, b = t.elements[h ? m : u],
            y = ze(_e(b) ? b : b.contextElement || ke(t.elements.popper), s, l), w = Ye(v),
            E = $e({reference: w, element: _, strategy: "absolute", placement: o}),
            L = Fe(Object.assign(Object.assign({}, _), E)), T = u === he ? L : w, k = {
        ...
        if (u === he && O) {
            ...
            Object.keys(k).forEach((function (t) {
                var e = [re, oe].indexOf(t) >= 0 ? 1 : -1, n = [ie, oe].indexOf(t) >= 0 ? "y" : "x";
                k[t] += C[n] * e
            }))
        }
        return k
    ...
    function Je(t, e) {
        ...
        var n = e, i = n.placement, o = n.boundary, r = n.rootBoundary, s = n.padding, a = n.flipVariations,
            l = n.allowedAutoPlacements, c = void 0 === l ? pe : l, u = Ke(i),
            f = u ? a ? de : de.filter((function (t) {
                return Ke(t) === u
            })) : le, h = f.filter((function (t) {
                return c.indexOf(t) >= 0
            }));
        0 === h.length && (h = f);
        var d = h.reduce((function (e, n) {
            return e[n] = Ge(t, {placement: n, boundary: o, rootBoundary: r, padding: s})[ye(n)], e
        }), {});
    ...
    function en(t, e, n) {
        void 0 === n && (n = !1);
        var i, o = ke(e), r = Ye(t), s = be(e), a = {scrollLeft: 0, scrollTop: 0}, l = {x: 0, y: 0};
    ...
    function sn(t) {
        void 0 === t && (t = {});
        var e = t, n = e.defaultModifiers, i = void 0 === n ? [] : n, o = e.defaultOptions, r = void 0 === o ? on : o;
    ...
    var an = sn({
            defaultModifiers: [{
                name: "eventListeners", enabled: !0, phase: "write", fn: function () {
                    ...
                    var e = t.state, n = t.instance, i = t.options, o = i.scroll, r = void 0 === o || o, s = i.resize,
                        a = void 0 === s || s, l = ve(e.elements.popper),
                    ...
                    var e = t.state, n = t.options, i = t.name, o = n.offset, r = void 0 === o ? [0, 0] : o,
                        s = pe.reduce((function (t, n) {
                            return t[n] = function (t, e, n) {
                                var i = ye(t), o = [se, ie].indexOf(i) >= 0 ? -1 : 1,
                                    r = "function" == typeof n ? n(Object.assign(Object.assign({}, e), {}, {placement: t})) : n,
                                    s = r[0], a = r[1];
                                return s = s || 0, a = (a || 0) * o, [se, re].indexOf(i) >= 0 ? {x: a, y: s} : {x: s, y: a}
                            }(n, e.rects, r), t
                ...
                name: "flip", enabled: !0, phase: "main", fn: function (t) {
                    ...
                    if (!e.modifiersData[i]._skip) {
                        for (var o = n.mainAxis, r = void 0 === o || o, s = n.altAxis, a = void 0 === s || s, l = n.fallbackPlacements, c = n.padding, u = n.boundary, f = n.rootBoundary, h = n.altBoundary, d = n.flipVariations, p = void 0 === d || d, g = n.allowedAutoPlacements, m = e.options.placement, v = ye(m), _ = l || (v === m || !p ? [Me(m)] : function (t) {
                            ...
                            var O = b[k], C = ye(O), S = Ke(O) === ce, A = [ie, oe].indexOf(C) >= 0,
                                x = A ? "width" : "height",
                                D = Ge(e, {placement: O, boundary: u, rootBoundary: f, altBoundary: h, padding: c}),
                                j = A ? S ? re : se : S ? oe : ie;
                            y[x] > w[x] && (j = Me(j));
                            var N = Me(j), I = [];
                ...
                name: "preventOverflow", enabled: !0, phase: "main", fn: function (t) {
                    var e = t.state, n = t.options, i = t.name, o = n.mainAxis, r = void 0 === o || o, s = n.altAxis,
                        ...
                        m = Ge(e, {boundary: l, rootBoundary: c, padding: f, altBoundary: u}), v = ye(e.placement),
                        _ = Ke(e.placement), b = !_, y = Ae(v), w = "x" === y ? "y" : "x",
                        E = e.modifiersData.popperOffsets, L = e.rects.reference, T = e.rects.popper,
                        k = "function" == typeof g ? g(Object.assign(Object.assign({}, e.rects), {}, {placement: e.placement})) : g,
                        O = {x: 0, y: 0};
                    if (E) {
                        if (r) {
                            var C = "y" === y ? ie : se, S = "y" === y ? oe : re, A = "y" === y ? "height" : "width",
                                x = E[y], D = E[y] + m[C], j = E[y] - m[S], N = d ? -T[A] / 2 : 0,
                                I = _ === ce ? L[A] : T[A], P = _ === ce ? -T[A] : -L[A], R = e.elements.arrow,
                                M = d && R ? we(R) : {width: 0, height: 0},
                                H = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : {
                                    top: 0,
                                    right: 0,
                                    bottom: 0,
                                    left: 0
                                }, W = H[C], Y = H[S], X = xe(0, L[A], M[A]),
                                ...
                                V = E[y] + B - F - Q, z = E[y] + U - F,
                                K = xe(d ? Math.min(D, V) : D, x, d ? Math.max(j, z) : j);
                            E[y] = K, O[y] = K - x
                        }
                        if (a) {
                            var $ = "x" === y ? ie : se, G = "x" === y ? oe : re, J = E[w], Z = xe(J + m[$], J, J - m[G]);
                            E[w] = Z, O[w] = Z - J
                        }
                        e.modifiersData[i] = O
                    }
                ...
                name: "arrow", enabled: !0, phase: "main", fn: function (t) {
                    var e, n = t.state, i = t.name, o = n.elements.arrow, r = n.modifiersData.popperOffsets,
                        s = ye(n.placement), a = Ae(s), l = [se, re].indexOf(s) >= 0 ? "height" : "width";
                    if (o && r) {
                        var c = n.modifiersData[i + "#persistent"].padding, u = we(o), f = "y" === a ? ie : se,
                            h = "y" === a ? oe : re,
                            d = n.rects.reference[l] + n.rects.reference[a] - r[a] - n.rects.popper[l],
                            p = r[a] - n.rects.reference[a], g = Se(o),
                            m = g ? "y" === a ? g.clientHeight || 0 : g.clientWidth || 0 : 0, v = d / 2 - p / 2, _ = c[f],
                            b = m - u[l] - c[h], y = m / 2 - u[l] / 2 + v, w = xe(_, y, b), E = a;
                        n.modifiersData[i] = ((e = {})[E] = w, e.centerOffset = w - y, e)
                    }
                }, effect: function (t) {
                    var e = t.state, n = t.options, i = t.name, o = n.element, r = void 0 === o ? "[data-popper-arrow]" : o,
                        s = n.padding, a = void 0 === s ? 0 : s;
                    null != r && ("string" != typeof r || (r = e.elements.popper.querySelector(r))) && Ee(e.elements.popper, r) && (e.elements.arrow = r, e.modifiersData[i + "#persistent"] = {padding: De("number" != typeof a ? a : je(a, le))})
                }, requires: ["popperOffsets"], requiresIfExists: ["preventOverflow"]
            }, {
                name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (t) {
                    var e = t.state, n = t.name, i = e.rects.reference, o = e.rects.popper,
                        r = e.modifiersData.preventOverflow, s = Ge(e, {elementContext: "reference"}),
                        a = Ge(e, {altBoundary: !0}), l = Ze(s, i), c = Ze(a, o, r), u = tn(l), f = tn(c);
                    e.modifiersData[n] = {
        ...
        _n = "click.coreui.dropdown.data-api", bn = "keydown.coreui.dropdown.data-api", yn = "disabled", wn = "show",
        En = "dropdown-menu-right", Ln = '[data-toggle="dropdown"]', Tn = ".dropdown-menu", kn = {
            offset: [0, 0],
            flip: !0,
            ...
            return n.toggle = function () {
                ...
                return "function" == typeof this._config.offset ? function (e) {
                    var n = e.placement, i = e.reference, o = e.popper;
                    return t._config.offset({placement: n, reference: i, popper: o})
                } : this._config.offset
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)) for (var n = at.find(Ln), i = 0, o = n.length; i < o; i++) {
                    var r = t.getParentFromElement(n[i]), s = O(n[i], cn), a = {relatedTarget: n[i]};
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? e.key === hn || e.key !== fn && (e.key !== pn && e.key !== dn || e.target.closest(Tn)) : !gn.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains(yn))) {
                    var n = t.getParentFromElement(this), i = n.classList.contains(wn);
    ...
    var xn = "modal", Dn = "coreui.modal", jn = "." + Dn, Nn = "Escape",
        In = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        Pn = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, Rn = "hidden" + jn,
        Mn = "show" + jn, Hn = "focusin" + jn, Wn = "resize" + jn, Yn = "click.dismiss" + jn,
        Xn = "keydown.dismiss" + jn, Bn = "mousedown.dismiss" + jn, Un = "modal-open", qn = "fade", Qn = "show",
        Fn = "modal-static", Vn = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", zn = ".sticky-top",
        Kn = function () {
            function t(t, e) {
            ...
            return n.toggle = function (t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var n = F.trigger(this._element, Mn, {relatedTarget: t});
                ...
                var e = this, n = this._element.classList.contains(qn), i = at.findOne(".modal-body", this._dialog);
                ...
                var o = function () {
                    e._config.focus && e._element.focus(), e._isTransitioning = !1, F.trigger(e._element, "shown.coreui.modal", {relatedTarget: t})
                };
                if (n) {
                ...
                var e = this, n = this._element.classList.contains(qn) ? qn : "";
                ...
                return this.each((function () {
                    var i = O(this, Dn),
                        r = o(o(o({}, In), bt.getDataAttributes(this)), "object" == typeof e && e ? e : {});
    ...
    var ii = "tooltip", oi = "coreui.tooltip", ri = "." + oi, si = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        ai = ["sanitize", "whiteList", "sanitizeFn"], li = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object",
            popperConfig: "(null|object)"
        }, ci = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, ui = {
            animation: !0,
        ...
        }, hi = "fade", di = "show", pi = "show", gi = "out", mi = "hover", vi = "focus", _i = function () {
            function t(t, e) {
            ...
            return n.enable = function () {
                ...
                if (this._isEnabled) if (t) {
                    var e = this.constructor.DATA_KEY, n = O(t.delegateTarget, e);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    var e = F.trigger(this.element, this.constructor.Event.SHOW), n = y(this.element),
                ...
                if (null !== t) return "object" == typeof e && m(e) ? (e.jquery && (e = e[0]), void (this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = ni(e, this.config.whiteList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
            }, n.getTitle = function () {
                ...
                return "function" == typeof this.config.offset ? function (e) {
                    var n = e.placement, i = e.reference, o = e.popper;
                    return t.config.offset({placement: n, reference: i, popper: o})
                } : this.config.offset
                ...
                var n = this.constructor.DATA_KEY;
                (e = e || O(t.delegateTarget, n)) || (e = new this.constructor(t.delegateTarget, this._getDelegateConfig()), k(t.delegateTarget, n, e)),
                t && (e._activeTrigger["focusout" === t.type ? vi : mi] = !1),
                e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = gi, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout((function () {
                ...
                var t = this.getTipElement(), e = t.getAttribute("class").match(si);
                ...
                return this.each((function () {
                    var n = O(this, oi), i = "object" == typeof e && e;
    ...
    var wi = "popover", Ei = "coreui.popover", Li = "." + Ei, Ti = new RegExp("(^|\\s)bs-popover\\S+", "g"),
        ki = o(o({}, _i.Default), {}, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), Oi = o(o({}, _i.DefaultType), {}, {content: "(string|element|function)"}), Ci = {
            HIDE: "hide" + Li,
            HIDDEN: "hidden" + Li,
            SHOW: "show" + Li,
            SHOWN: "shown" + Li,
            ...
            return r.isWithContent = function () {
                ...
                var t = this.getTipElement(), e = t.getAttribute("class").match(Ti);
                null !== e && e.length > 0 && e.map((function (t) {
                    return t.trim()
                })).forEach((function (e) {
                    return t.classList.remove(e)
                ...
                return this.each((function () {
                    var e = O(this, Ei), n = "object" == typeof t ? t : null;
    ...
    var Di = "scrollspy", ji = "coreui.scrollspy", Ni = "." + ji, Ii = {offset: 10, method: "auto", target: ""},
        Pi = {offset: "number", method: "string", target: "(string|element)"}, Ri = "dropdown-item", Mi = "active",
        Hi = ".nav-link", Wi = "position", Yi = function () {
            function t(t, e) {
                var n = this;
            ...
            return n.refresh = function () {
                var t = this, e = this._scrollElement === this._scrollElement.window ? "offset" : Wi,
                    n = "auto" === this._config.method ? e : this._config.method, i = n === Wi ? this._getScrollTop() : 0;
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), at.find(this._selector).map((function (t) {
                    var e = h(t), o = e ? at.findOne(e) : null;
                    if (o) {
                ...
                if ("string" != typeof (t = o(o({}, Ii), "object" == typeof t && t ? t : {})).target && m(t.target)) {
                    var e = t.target.id;
                ...
                }))), F.trigger(this._scrollElement, "activate.coreui.scrollspy", {relatedTarget: t})
            }, n._clear = function () {
   ...
   */
    ...
    function eo(t, e) {
        var n = t.element.classList, i = Zi.scrolling(e);
    ...
    function uo(t) {
        var e = t.element, n = Math.floor(e.scrollTop), i = e.getBoundingClientRect();
        t.containerWidth = Math.ceil(i.width), t.containerHeight = Math.ceil(i.height), t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (Ki(e, Ji.rail("x")).forEach((function (t) {
            ...
            var n = {width: e.railXWidth}, i = Math.floor(t.scrollTop);
            ...
            }), qi(e.scrollbarY, {top: e.scrollbarYTop, height: e.scrollbarYHeight - e.railBorderYWidth})
    ...
    function ho(t, e) {
        var n = e[0], i = e[1], o = e[2], r = e[3], s = e[4], a = e[5], l = e[6], c = e[7], u = e[8], f = t.element,
    ...
    var po = {
        "click-rail": function (t) {
            ...
            function n(n) {
                ...
                if (!function (t, n, i) {
                    ...
                    t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (r ? e.scrollTop -= r * t.settings.wheelSpeed : e.scrollTop += o * t.settings.wheelSpeed, s = !0) : t.scrollbarXActive && !t.scrollbarYActive && (o ? e.scrollLeft += o * t.settings.wheelSpeed : e.scrollLeft -= r * t.settings.wheelSpeed, s = !0) : (e.scrollTop -= r * t.settings.wheelSpeed, e.scrollLeft += o * t.settings.wheelSpeed), uo(t), (s = s || function (n, i) {
                        var o = Math.floor(e.scrollTop), r = 0 === e.scrollTop,
                            s = o + e.offsetHeight === e.scrollHeight, a = 0 === e.scrollLeft,
            ...
            if (co.supportsTouch || co.supportsIePointer) {
                var e = t.element, n = {}, i = 0, o = {}, r = null;
            ...
            function u(r) {
                if (l(r)) {
                    ...
                    p > 0 && (o.x = f / p, o.y = h / p, i = d), function (n, i) {
                        var o = Math.floor(e.scrollTop), r = e.scrollLeft, s = Math.abs(n), a = Math.abs(i);
                        if (a > s) {
        ...
        this.scrollbarXBottom = parseInt(l.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = lo(l.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = lo(l.borderLeftWidth) + lo(l.borderRightWidth), qi(this.scrollbarXRail, {display: "block"}), this.railXMarginWidth = lo(l.marginLeft) + lo(l.marginRight), qi(this.scrollbarXRail, {display: ""}), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = Qi(Ji.rail("y")), t.appendChild(this.scrollbarYRail), this.scrollbarY = Qi(Ji.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", s), this.event.bind(this.scrollbarY, "blur", a), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
        ...
        }(this.scrollbarY) : null, this.railBorderYWidth = lo(c.borderTopWidth) + lo(c.borderBottomWidth), qi(this.scrollbarYRail, {display: "block"}), this.railYMarginHeight = lo(c.marginTop) + lo(c.marginBottom), qi(this.scrollbarYRail, {display: ""}), this.railYHeight = null, this.railYRatio = null, this.reach = {
    ...
    var mo = "sidebar", vo = "coreui.sidebar", _o = {
            activeLinksExact: !0,
            breakpoints: {
                xs: "c-sidebar-show",
            ...
            dropdownAccordion: !0
        }, bo = {activeLinksExact: "boolean", breakpoints: "object", dropdownAccordion: "(string|boolean)"},
        yo = "c-active", wo = "c-sidebar-nav-dropdown", Eo = "c-show", Lo = "c-sidebar-minimized",
        To = "c-sidebar-unfoldable", ko = "click.coreui.sidebar.data-api", Oo = ".c-sidebar-nav-dropdown-toggle",
        Co = ".c-sidebar-nav-dropdown", So = ".c-sidebar-nav-link", Ao = ".c-sidebar-nav", xo = ".c-sidebar",
        Do = function () {
            function t(t, e) {
            ...
            return n.open = function (t) {
                ...
                this._mobile && this._open && this._addClickOutListener(), this._overlaid && this._open && this._addClickOutListener(), F.on(this._element, "classtoggle", (function (e) {
                    if (e.detail.className === Lo && (t._element.classList.contains(Lo) ? t.minimize() : t.reset()), e.detail.className === To && (t._element.classList.contains(To) ? t.unfoldable() : t.reset()), "undefined" != typeof Object.keys(_o.breakpoints).find((function (t) {
                        ...
                        var n = e.detail.className, i = Object.keys(_o.breakpoints).find((function (t) {
    ...
    var Io = "coreui.tab", Po = "active", Ro = "fade", Mo = "show", Ho = ".active", Wo = ":scope > li > .active",
        Yo = function () {
            function t(t) {
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(Po) || this._element.classList.contains("disabled"))) {
                    ...
                    var r = null;
                    if (e && (r = F.trigger(e, "hide.coreui.tab", {relatedTarget: this._element})), !(F.trigger(this._element, "show.coreui.tab", {relatedTarget: e}).defaultPrevented || null !== r && r.defaultPrevented)) {
                        this._activate(this._element, i);
                        var s = function () {
                            F.trigger(e, "hidden.coreui.tab", {relatedTarget: t._element}), F.trigger(t._element, "shown.coreui.tab", {relatedTarget: e})
                        };
                ...
                var i = this,
                    ...
                    r = n && o && o.classList.contains(Ro), s = function () {
    ...
    var Uo, qo, Qo, Fo, Vo, zo = "toast", Ko = "coreui.toast", $o = "." + Ko, Go = "click.dismiss" + $o, Jo = "hide",
        Zo = "show", tr = "showing", er = {animation: "boolean", autohide: "boolean", delay: "number"},
        nr = {animation: !0, autohide: !0, delay: 5e3}, ir = function () {
            function t(t, e) {
            ...
            return n.show = function () {
                ...
                return t = o(o(o({}, nr), bt.getDataAttributes(this._element)), "object" == typeof t && t ? t : {}), _(zo, t, this.constructor.DefaultType), t
            }, n._setListeners = function () {
                var t = this;
    ...
    return Array.from || (Array.from = (Uo = Object.prototype.toString, qo = function (t) {
        return "function" == typeof t || "[object Function]" === Uo.call(t)
    }, Qo = Math.pow(2, 53) - 1, Fo = function (t) {
        var e = function (t) {
            var e = Number(t);
        ...
        for (var r, s = Fo(n.length), a = qo(e) ? Object(new e(s)) : new Array(s), l = 0; l < s;) r = n[l], a[l] = o ? "undefined" == typeof i ? o(r, l) : o.call(i, r, l) : r, l += 1;
        return a.length = s, a
    ...
    }, "object" == typeof exports && "undefined" != typeof module ? Vo() : "function" == typeof define && define.amd ? define(Vo) : Vo(), function () {
        function t(t, e) {
